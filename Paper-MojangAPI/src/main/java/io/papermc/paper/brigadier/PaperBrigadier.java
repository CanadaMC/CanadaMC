...
public final class PaperBrigadier {
     ...
     *
     * <p>Mostly useful for creating rich suggestion tooltips in combination with other
     * Paper-MojangAPI APIs.
     *
     ...
     *
     * <p>If the {@link Message} was created from a {@link Component}, it will simply be converted
     * back, otherwise a new {@link TextComponent} will be created with the content of {@link
     * Message#getString()}
     *
